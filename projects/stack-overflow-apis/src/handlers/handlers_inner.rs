...
pub async fn delete_question(
    ...
    let question_uuid_clone = question_uuid.question_uuid.clone();
    let result = questions_dao
        .delete_question(question_uuid_clone.clone())
        .await;

    match result {
        Ok(_) => Ok(format!(
            "Question with UUID {} deleted successfully",
            question_uuid_clone
        )),
...
pub async fn delete_answer(
    ...
    let answer_uuid_clone = answer_uuid.answer_uuid.clone();
    let result = answers_dao.delete_answer(answer_uuid_clone.clone()).await;
    ...
    match result {
        Ok(_) => Ok(format!(
            "Answer with UUID {} deleted successfully",
            answer_uuid_clone
        )),
        Err(_) => Err(HandlerError::default_internal_error()),
    }
...
mod tests {
    ...
    struct QuestionsDaoMock {
        ...
        delete_question_response: Mutex<Option<Result<String, DBError>>>,
    ...
    impl QuestionsDaoMock {
        ...
        pub fn mock_delete_question(&mut self, response: Result<String, DBError>) {
    ...
    impl QuestionsDao for QuestionsDaoMock {
        ...
        async fn delete_question(&self, _: String) -> Result<String, DBError> {
    ...
    struct AnswersDaoMock {
        ...
        delete_answer_response: Mutex<Option<Result<String, DBError>>>,
    ...
    impl AnswersDaoMock {
        ...
        pub fn mock_delete_answer(&mut self, response: Result<String, DBError>) {
    ...
    impl AnswersDao for AnswersDaoMock {
        ...
        async fn delete_answer(&self, _: String) -> Result<String, DBError> {
    ...
    async fn delete_question_should_succeed() {
        ...
        questions_dao
            .mock_delete_question(Ok("Question with UUID 123 deleted successfully".to_owned()));
        ...
        assert_eq!(
            result.unwrap(),
            "Question with UUID 123 deleted successfully".to_owned()
        );
    }
    ...
    async fn delete_answer_should_succeed() {
        ...
        answers_dao.mock_delete_answer(Ok("Answer with UUID 123 deleted successfully".to_owned()));
        ...
        assert_eq!(
            result.unwrap(),
            "Answer with UUID 123 deleted successfully".to_owned()
        );
    }
