...
pub fn get_column_string(text: &str, width: usize) -> String {
    ...
    // Compare the length of the text with the width
    match len.cmp(&width) {
        // If the length of the text is less than the width
        ...
        // If the length of the text is equal to the width
        std::cmp::Ordering::Equal => text.to_owned(),
        // If the length of the text is greater than the width
